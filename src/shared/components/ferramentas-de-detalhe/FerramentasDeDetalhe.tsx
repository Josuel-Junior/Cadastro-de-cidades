...
export const FerramentasDeDetalhe: React.FC<IFerramentasDeDetalhe> = ({
  ...
  return (
    ...
    >
      ...
      {mostrarBotaoSalvarCarregando && <Skeleton width={111} height={60} />}
      ...
      {mostrarBotaoApagarCarregando && <Skeleton width={115} height={60} />}
      ...
      {(mostrarBotaoNovoCarregando && !smDown) && <Skeleton width={98} height={60} />}
